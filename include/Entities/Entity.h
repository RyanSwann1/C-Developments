...
{
public:
	Entity(SharedContext& sharedContext, const EntityType type, const sf::Vector2f& pos, const int ID, const std::string& name);
	virtual ~Entity() {}
...
protected:
	...
	inline AnimationManager& getSpriteSheet() { return m_animationManager; }
